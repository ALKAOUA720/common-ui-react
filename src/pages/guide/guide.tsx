...
const Guide: React.FC<{
  ...
  return (
    <div className={css.block} ref={ref}>
      ...
      <div className={css.main}>{map[componentName]}</div>
    </div>
  );
};
...
const PopoverGuide: React.FC<{}> = () => {
  ...
  return (
    <>
      ...
      <Popover content={"popover"} trigger={"click"} placement={"top-right"}>
      ...
      <div className={css["horizontal-box"]}>
        ...
        <Popover content={"popover-top"} trigger={"hover"} placement={"top"}>
        ...
        footer={
          <div
            className={classNames(
              css["modal-custom-footer-button"],
              "primary-button"
            )}
            onClick={() => {
          ...
          Modal.show({
            title: (
              <div className={css["modal-custom-title"]}>
                <img
                  className={css["modal-custom-title-icon"]}
                  src={customTitleIcon}
                />
                <span>自定义标题</span>
              </div>
